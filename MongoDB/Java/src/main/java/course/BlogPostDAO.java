...
public class BlogPostDAO {
    ...
    public void likePost(final String permalink, final int ordinal) {
		...
		// postsCollection.updateOne(new Document("permalink", permalink), new Document("$set", new Document("comments." + ordinal, comment)));
		postsCollection.updateOne(eq("permalink", permalink), new Document("$set", new Document("comments." + ordinal, comment)));
    }
}
